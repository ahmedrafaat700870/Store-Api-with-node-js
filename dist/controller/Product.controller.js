...
exports.Create = exports.DeleteOne = exports.UpdataOne = exports.GetAll = exports.GetOne = void 0;
...
var GetOne = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, ProductModel.GetOne(req.body.id)];
            case 1:
                Product = _a.sent();
                res
                    .status(200)
...
var UpdataOne = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var Product, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
var DeleteOne = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, ProductModel.DelteOne(req.body.id)];
            case 1:
                Product = _a.sent();
                res
                    .status(200)
