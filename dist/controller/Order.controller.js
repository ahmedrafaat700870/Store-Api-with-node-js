...
exports.DeleteOne = exports.CreateOne = exports.UpdateOne = exports.GetAll = exports.GetOne = void 0;
...
var GetOne = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, OrderModel.GetOne(req.body.User_id)];
            case 1:
                Order = _a.sent();
                res.status(200).json({
                    status: 'Success',
...
var GetAll = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, OrderModel.GetALLProduct()];
            case 1:
                Orders = _a.sent();
                res.status(200).json({
                    status: 'Success',
...
var DeleteOne = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var Order_updated, error_5;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, OrderModel.DeleteOne(req.body.User_id)];
            case 1:
                Order_updated = _a.sent();
                res.status(200).json({
                    status: 'Success',
